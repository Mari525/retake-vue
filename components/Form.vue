    ...
    <div>
        ...
        <div v-if="show">
            <v-form>
                    ...
                    <v-btn outlined class="mb-10" @click="send" style="margin-top: 20px; display: block;" type="submit">Отправить</v-btn>
            </v-form>
        </div>
        <div v-else>
            <v-btn outlined class="mb-10" @click="show = !show">Показать форму</v-btn>
        </div>
    </div>
</template>
